...
public interface IAdministradoresRepository extends JpaRepository<Administradores, Integer> {
	...
	void insertarAdministrador(String nombre1, String nombre2, String apellido1, String apellido2,
			String curp, String telefono, String numeroTrabajador,
			LocalDate fechaNacimiento, Character sexo, String emailAdmin);
	...
	Administradores obtenerAdministradores(Integer idAdministrador);
