...
begin
	select id_administrador,nombre1,nombre2,apellido1,apellido2,curp,telefono,numero_trabajador, fecha_nacimiento,sexo, email_admin from administradores where id_administrador=id_admin and estatus=1;
end
$$
DELIMITER ;
...
begin
    select id_catedratico,nombre,nombre2,apellido,apellido2,curp,telefono,sexo,fecha_nacimiento,numero_trabajador,email_catedratico from catedraticos where id_catedratico=id_cat;
end
$$
DELIMITER ;
