...
public interface ICatedraticosRepository extends JpaRepository<Catedraticos, Integer>{
	/**
	 * @param Procedimiento almacenado para insertar una lista de todos los catedraticos.
	 * */
	...
	/**
	 * @return Procedimiento almacenado para obtener una lista de todos los catedraticos.
	 */
	@Procedure(name = "obtenerTodosCatedraticos")	
	List<Catedraticos> obtenerTodosCatedraticos();
	
	/**
	 * @param Procedimiento almacenado para eliminar un catedraticos.
	 */
	@Procedure(name = "eliminarCatedratico")	
	void eliminarCatedratico (Integer id_catedratico);
	
	/**
	 * @param Procedimiento almacenado para obtener un catedraticos en especifico, con su Id.
	 * @return el catedratico solicitado.
	 */
	@Procedure(name = "obtenerCatedratico")	
	Catedraticos obtenerCatedratico (Integer id_catedratico);
	
	/**
	* @param Procedimiento almacenado para actualizar un catedraticos.
	*/
	@Procedure(name = "actualizarCatedraticos")	
	void actualizarCatedraticos (Integer id_catedraticoAux, String nombreAux, String nombre2Aux, String apellidoAux, String apellido2Aux,
